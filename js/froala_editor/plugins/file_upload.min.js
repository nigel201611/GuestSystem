...
!function(a){
    a.Editable.commands=a.extend(a.Editable.commands, {
            uploadFile:{
                title:"Upload File",icon:"fa fa-paperclip",
                callback:function(){
                    this.insertFile()
                },undo:!1
            }
    ...
    a.Editable.prototype.insertFile=function(){
        ...
        this.options.inlineMode||this.positionPopup("uploadFile")
    },
    a.Editable.prototype.fileUploadHTML=function(){
        var b='<div class="froala-popup froala-file-popup" style="display: none;">' +
            '<h4><span data-text="true">Upload file</span>' +
            '<i title="Cancel" class="fa fa-times" id="f-file-close-'+this._id+'"></i>' +
            '</h4>';
        ...
        this.browser.msie&&a.Editable.getIEversion()<=9&&(b+='<iframe id="file-frame-'+this._id+'" name="file-frame-'+this._id+'" src="javascript:false;" style="width:0; height:0; border:0px solid #FFF; position: fixed; z-index: -1;" data-loaded="true"></iframe>'),b+="</div>",b+="</div>",b+='<p class="f-progress" id="f-file-progress-'+this._id+'"><span></span></p>',b+="</div>"},
        a.Editable.prototype.buildFileDrag=function(){
        var b=this;b.$file_wrapper.on("dragover","#f-file-upload-div-"+this._id,function(){
        ...
        b.$file_wrapper.on("drop","#f-file-upload-div-"+this._id,function(c){
            ...
            b.uploadFile(c.originalEvent.dataTransfer.files)
        })
        }
        ,a.Editable.prototype.buildFileUpload=function(){
            ...
            if(this.addListener("hidePopups",a.proxy(function(){
                ...
                var c=this.$file_wrapper.find("iframe").get(0);c.attachEvent?c.attachEvent("onload",function(){
                    b.iFrameLoad()}):c.onload=function(){
                    b.iFrameLoad()}
            }this.$file_wrapper.on("change",'input[type="file"]',
            function(){
                if(void 0!==this.files)
                    ...
                    var d;
                    for(d in b.options.fileUploadParams)
                        c.prepend('<input type="hidden" name="'+d+'" value="'+b.options.fileUploadParams[d]+'" />');
